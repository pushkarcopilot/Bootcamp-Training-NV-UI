...
const ViewEngagement = () => {
  ...
  const fetchEngagement = () => {
    fetch(
      `https://localhost:44326/api/ViewEngagement/GetEngagementByEngagementId?EngagementId=${id}`
    )
          ...
          <form method="post">
            ...
            <div className="form-row">
              <div className="form-group col-md-6">
                <label htmlFor="clientnamelbl">Client Name</label>{" "}
                <PencilFill />
                <input
                  type="text"
            ...
            <div className="form-row">
              <div className="form-group col-md-6">
                <label htmlFor="auditorlbl">Auditors</label>
                <PencilFill />
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="form-group col-md-6">
                ...
                >
                  ...
                  {auditsts.map((option) => (
                    <option
                      key={option.auditStatusId}
                      value={option.auditStatusId}
                    >
                      {option.auditStatus}
                    </option>
                  ))}
